...
<div id="splash">
  ...
  <main id="main">
          ...
          <div class="fcard-list">
            ...
            <div class="fcard">
              <div class="fcard-inner">
                ...
                <div class="f-para">
                  <p>ラクハブにログインするだけでリアルタイムで最新の情報が共有できるので、担当者の引き継ぎの際にも共有漏れが起きることがありません。<br />過去のデータも遡って確認できるため、データの紛失のリスクもありません。他のシステムやエクセルでの管理からラクハブに移行する際にもデータインポート機能を使うことで楽に移行ができます。</p>
                </div>
              </div>
            </div>
            <div class="fcard">
        ...
        <div class="container">
          <div class="footer-blk">
            ...
            <div class="footer-txt">
              <a href="./tokutei.html" target="_blank">
    ...
    <div class="modal-box-doc-thanks">
      <div class="modal-wrapper">
        <div class="modal-close"></div>
        <h5 class="ttl">資料ダウンロード</h5>
